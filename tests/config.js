module.exports = {
  ...
  TestShowBrowserWindow: true || true,
  TestRetryFeatures: 0,
  ...
  TestEnvProfUser: process.env.CCD_CASEWORKER_E2E_EMAIL || 'divorce_as_caseworker_beta@mailinator.com',
  TestEnvProfPassword: process.env.CCD_CASEWORKER_E2E_PASSWORD || 'Testing1234',
