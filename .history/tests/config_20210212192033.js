module.exports = {
  ...
  TestEnvSolPetOrgUser: process.env.E2E_SOLICITOR_PET_ORG_USER ||'divorce_as_petitioner_solicitor_01@mailinator.com',
  TestEnvSolPetOrgPassword: process.env.E2E_SOLICITOR_PET_ORG_PASSWORD || 'Testing1234',
